...
<section className="py-20" style={{ background: "oklch(0.17 0.055 240)" }}>
  <div className="container">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
      {[
        { icon: "✅", title: "Ücretsiz Keşif", text: "İş başlamadan önce alanı inceler, ihtiyaca uygun çözüm ve fiyat teklifi sunarız." },
        { icon: "🛠️", title: "Garantili İşçilik", text: "Uygulamalarımızda kaliteli malzeme ve düzgün işçilik prensibiyle çalışırız." },
        { icon: "⏱️", title: "Zamanında Teslim", text: "İşi planlanan sürede bitirmek için programlı ve disiplinli çalışırız." },
        { icon: "💰", title: "Uygun Fiyat", text: "Malzeme, metrekare ve uygulama detayına göre şeffaf fiyatlandırma yaparız." },
        { icon: "🏗️", title: "Anahtar Teslim Çözüm", text: "Asma tavan, alçıpan, prefabrik ve dekorasyon işlerini tek elden yürütürüz." },
        { icon: "📞", title: "Hızlı İletişim", text: "WhatsApp ve telefon üzerinden hızlı dönüş sağlayarak teklif sürecini kolaylaştırırız." },
      ].map((item) => (
        <div
          key={item.title}
        ...
        >
          ...
          <p className="text-sm leading-7" style={{ color: "oklch(0.60 0.03 230)" }}>
            {item.text}
          </p>
        </div>
      ))}
